...
export interface CredentialOfferParameters {
     ...
     * If using connectionless issuance, these attributes must be specified.
...
export interface WebhookContract {
    url?: string;
    /**
     * Possible values include: 'Notification', 'DelegatedEndorser', 'Zapier'
     */
    type?: Type;
    enabled?: boolean;
    id?: string;
...
/**
 * An interface representing CredentialsServiceClientOptions.
 */
export interface CredentialsServiceClientOptions extends ServiceClientOptions {
    baseUri?: string;
}
/**
 * Optional Parameters.
 */
export interface CredentialsServiceClientUploadImageOptionalParams extends msRest.RequestOptionsBase {
    /**
     * The filename
     */
    filename?: string;
 ...
 * Optional Parameters.
 */
export interface CredentialsServiceClientListConnectionsOptionalParams extends msRest.RequestOptionsBase {
    /**
 ...
 * Optional Parameters.
 */
export interface CredentialsServiceClientIssueCredentialOptionalParams extends msRest.RequestOptionsBase {
    /**
 ...
 * @enum {string}
 */
export declare type Type = 'Notification' | 'DelegatedEndorser' | 'Zapier';
/**
 ...
 * @enum {string}
 */
export declare type Type1 = 'Notification' | 'DelegatedEndorser' | 'Zapier';
/**
